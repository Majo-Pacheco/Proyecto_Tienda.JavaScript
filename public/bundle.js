...
const formatearMoneda = new Intl.NumberFormat("en-US", {style: "currency", currency: "USD"});
...
const renderCarrito = () => {
    ...
    if(carrito.length < 1){
        //Pongo la clase de carrito vacío
        ventanaCarrito.classList.add("carrito--vacio");

    } else {
        // Elimino la clase de carrito vacío
        ventanaCarrito.classList.remove("carrito--vacio");

        // Iteramos sobre cada producto del carrito y lo mostramos
    carrito.forEach((productoCarrito) => {

        // Obtengo el precio del archivo de productos.js, cuando el id del item del carrito sea el mismo que alguno de la base de datos de productos.js
        ...
        // Estblecemos la ruta de la imagen que queremos mostrar
        ...
        // Creo una plantilla del código HTML
...
btnAgregarCarrito.addEventListener("click", (e) => {
    ...
    // Sumo productos iguales en el carrito 
    ...
    // Establezco la ruta de la img que quiero ostrar en la notificación del carrito
    let thumbSrc = producto.querySelectorAll(".producto__thumb-img")[0].src;
    if(color === "rojo"){
        thumbSrc = "./img/thumbs/rojo.jpg";
